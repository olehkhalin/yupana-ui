...
import s from "./DesktopPagination.module.sass";

type DesktopPaginationProps = {
  className?: string;
} & PaginationInterface;

export const DesktopPagination: FC<DesktopPaginationProps> = ({
  canPreviousPage,
  canNextPage,
  pageIndex,
  pageCount,
